    ...
    <html lang='en'>
      <body className={inter.className}>
        <div className='relative min-h-screen isolate overflow-hidden border-b border-gray-200 bg-white text-slate-900'>
          ...
          <div className='mx-auto max-w-7xl px-6 pb-24 pt-10 lg:flex gap-16 lg:px-8 lg:py-24'>
            <div className='h-full w-full flex flex-col items-center gap-4'>
              <Icons.Sparkles className='h-16 w-16' />
              <h1 className='tracking-tighter text-4xl sm:text-6xl font-bold'>
                MagicSearch
              </h1>
              <p className='max-w-xl text-center text-lg text-slate-700'>
                A hybrid Seach engine that enhances Serach using Semantically
